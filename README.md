...
handle_choice() {
  ...
  case "$choice" in
    1) bash "$SCRIPTS_DIR/server_actions.sh" start ;;
    2) bash "$SCRIPTS_DIR/server_actions.sh" stop ;;
    3) bash "$SCRIPTS_DIR/server_actions.sh" restart ;;
    4) bash "$SCRIPTS_DIR/logs.sh" tail ;;
    5) backup_menu ;;
    6) bash "$SCRIPTS_DIR/versions.sh"
